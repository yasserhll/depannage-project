...
import { Home, ClipboardList, Wallet, User, LogOut, X, AlertTriangle } from 'lucide-react';
...
const NAV_ITEMS = [
  { to: '/depanneur',          label: 'Tableau bord', Icon: Home,          end: true  },
  { to: '/depanneur/missions', label: 'Missions',     Icon: ClipboardList, end: false },
  { to: '/depanneur/wallet',   label: 'Wallet',       Icon: Wallet,        end: false },
  { to: '/depanneur/profil',   label: 'Profil',       Icon: User,          end: false },
];
      ...
      <header className="flex items-center justify-between px-4 py-3 bg-surface border-b border-brand-border sticky top-0 z-40">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-blue-400 text-[10px] font-medium">Espace Dépanneur</p>
          </div>
        </div>
        <button
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              cn(
                ...
                isActive ? 'text-blue-400' : 'text-brand-muted hover:text-brand-text',
              )
            }
          >
            {({ isActive }) => (
